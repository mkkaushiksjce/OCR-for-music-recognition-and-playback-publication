...
\author{C.R.~Nataraj,~\IEEEmembership{Professor,~Dept.~of~E\&C~SJCE~Mysore,}
...
\begin{abstract}
%\boldmath
OCR for music recognition and playback aims to address the problem of music data acquisition 
\end{abstract}
...
\begin{IEEEkeywords}
OCR, journal, \LaTeX, paper, template.
\end{IEEEkeywords}
