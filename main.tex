...
\[ b = f - (f \ominus s) \]
where f is an image of the regions, s is structuring element, and b is an image of the region
boundaries. Figure 4.6 shows the effects of erosion on an input image
